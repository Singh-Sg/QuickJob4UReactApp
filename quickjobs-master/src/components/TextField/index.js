  ...
  render() {
    ...
    return (
      <View style={[styles.inputView, style]}>
        ...
        <TextInput
          style={[styles.input, inputStyle, {borderWidth: numberOfLines ? 1 : 0, borderColor: numberOfLines ? '#dedede' : '#fff', borderRadius: numberOfLines ? 10 : 0, marginTop: numberOfLines ? 10 : 0, height: numberOfLines ? 100 : 34}]}
        ...
        />
        {desc && <HTML onLinkPress={(evt, href) => { Linking.openURL(href); }}  html={desc} imagesMaxWidth="100%" />}
      </View>
    );
  }
}