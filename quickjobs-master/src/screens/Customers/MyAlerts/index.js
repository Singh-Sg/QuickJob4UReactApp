        ...
        <View style={pageStyle.listing}>
          <TouchableOpacity>
            <View style={pageStyle.listItem}>
              ...
              <Switch onTintColor={Platform.OS == 'android' ? "red" : "#efefef"} thumbTintColor="red" value={this.state.sms} onValueChange={() => this.setState({
          ...
          <TouchableOpacity>
            <View style={pageStyle.listItem}>
              ...
              <Switch onTintColor={Platform.OS == 'android' ? "red" : "#efefef"} thumbTintColor="red" value={this.state.email} onValueChange={() => this.setState({
          ...
          <TouchableOpacity>
            <View style={pageStyle.listItem}>
              ...
              <Switch onTintColor={Platform.OS == 'android' ? "red" : "#efefef"} thumbTintColor="red" value={this.state.notification} onValueChange={() => this.setState({
          ...
          <Button containerStyle={{paddingHorizontal: '20%'}} style={{backgroundColor: '#cf2525', paddingVertical: 10}} text="SAVE" onPress={() => this.saveData()} loading={this.state.loading} />
        </View>
      </ScrollView>
    );
  }
